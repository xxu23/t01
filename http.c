...
struct http_response *http_response_init(struct event_base *base, int code, const char *msg) {
	...
	http_response_set_header(r, "Server", "T01WebServer");

	/* Cross-Origin Resource Sharing, CORS. */
	http_response_set_header(r, "Allow", "GET,POST,PUT,DELETE,OPTIONS");
	/*
	Chrome doesn't support Allow and requires 
	Access-Control-Allow-Methods
	*/
	http_response_set_header(r, "Access-Control-Allow-Methods", "GET,POST,PUT,DELETE,OPTIONS");
